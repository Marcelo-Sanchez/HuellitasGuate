...
namespace HuellitasGuate.Controllers
{
    public class ServiciosController : Controller
    {
        ...
        public ServiciosController(HuellitasGuateContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Servicios != null ? 
                          ...
                          Problem("Entity set 'HuellitasGuateContext.Servicios'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'HuellitasGuateContext.Servicios'  is null.");
            }
            var servicio = await _context.Servicios.FindAsync(id);
            if (servicio != null)
            {
